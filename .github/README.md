...
**Scope:** Compares changed files in `apps/` and `deployment_scripts/` against `main`. Only apps with a `deployment_scripts/<app>/linode-config.sh` are deployed.
...
**Scope:** Deploys and runs **all apps**
