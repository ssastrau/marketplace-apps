---
description: Phase 6 (last) — write the app README from the validated final version and DRAFT the PR in the repo's .github/pull_request_template.md format for operator review. Does NOT create the PR. Claude never pushes, merges, or opens the PR. User-invoked only.
disable-model-invocation: true
arguments: [app]
---

# App: PR (Phase 6 — README + PR draft)
...
### Phase 6b — Draft the PR body (repo template format)
...
### Phase 6c — STOP (operator reviews + submits)
